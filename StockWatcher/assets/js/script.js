    ...
    $(document).ready(function () {
      ...
      $(document).ready(function () {
        $(".cryptoBtn").on("click", function () {
          ...
          var requestUrl = 'https://rest.coinapi.io/v1/exchangerate/'+cryptoSymbol.toUpperCase()+'/USD/?apiKey=76534041-EF29-40D8-AC91-75939BEF8C76';
        ...
        $(".cryptoBtn").on("click", function () {
          ...
          var requestUrl = 'https://rest.coinapi.io/v1/exchangerate/'+cryptoName.toUpperCase()+'/USD/history?period_id=1DAY&time_start='+oneMonth+'T00:00:00&time_end='+today+'T00:00:00&apiKey=C4D62BF3-1B0B-45D4-9A3F-48DC7D801132'
            fetch(requestUrl)
              ...
              .then(function (data) {
                console.log(cryptoChartData.length + "look at me")
              if(cryptoChartData.length  > 29){
                ...
                chartContainer.append(cryptoChart)
                const mycryptoChart = new Chart(cryptoChart, {
                  type: 'line',
                  data: {
                      labels: ['1 Day','3 Days','7 Days','14 Days','21 Days', '28 Days'],
                      datasets: [{
                          label: 'Past 28 Days',
