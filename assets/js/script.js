      ...
      $(document).ready(function () {
        ...
        console.log(requestUrl)
          ...
          $(document).ready(function () {
            ...
            if(cryptoNames != null)
            {
              var requestUrl = 'https://rest.coinapi.io/v1/exchangerate/'+cryptoNames.toUpperCase()+'/USD/?apiKey=76534041-EF29-40D8-AC91-75939BEF8C76';
              fetch(requestUrl)
              .then(function (response) {
                return response.json();
              })
    ...
    $(document).ready(function () {
      $(".stockBtn").on("click", function () {
       ...
       $(document).ready(function () {
        $(".cryptoBtn").on("click", function () {
          ...
          var requestUrl = 'https://rest.coinapi.io/v1/exchangerate/'+cryptoName.toUpperCase()+'/USD/history?period_id=1DAY&time_start='+oneMonth+'T00:00:00&time_end='+today+'T00:00:00&apiKey=76534041-EF29-40D8-AC91-75939BEF8C76'
            fetch(requestUrl)
              .then(function (response) {
                return response.json();
              })
              .then(function (data) {
                ...
                var cryptoName = document.createElement('h3');
                var cryptoChart = document.createElement('canvas')
                cryptoChart.setAttribute('id','cryptoChart')
                cryptoContainer.append(cryptoName)
                cryptoContainer.append(cryptoChart)
                const mycryptoChart = new Chart(cryptoChart, {
                  type: 'line',
                  data: {
                      labels: ['1 Day','3 Days','7 Days','14 Days','21 Days', '8 Days'],
                      datasets: [{
                          label: 'stockValue',
      ...
      $(document).ready(function () {
        $(".cryptoBtn").on("click", function () {
              ...
              // Get nearby values 
          var cryptoName = $(this).siblings(".description").val();
          var requestUrl = 'https://rest.coinapi.io/v1/exchangerate/'+cryptoName.toUpperCase()+'/USD/?apiKey=76534041-EF29-40D8-AC91-75939BEF8C76';
